...
package 
{
	...
	/**
	 * The ScrollableAxisRenderer class enables scrolling and zooming the chart.
	 * 
	 ...
	 * <pre>
	 * TODO:
	 *  - change cursor when dragging axis
	 *  - dispatch event after a specified period of time from last change indicating 
	 *    that scrolling/zooming is done and new data may be needed.
	 *  - delay resetting of cached min/max
	 *  - draw transparent rectangle to catch mouse events on greater area
	 * </pre>
	 */
