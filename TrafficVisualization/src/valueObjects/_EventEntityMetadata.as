...
internal class _EventEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    ...
    model_internal static var allProperties:Array = new Array("date", "type", "tl", "data");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("date", "type", "tl", "data");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("date", "type", "tl", "data");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("date", "type", "tl", "data");
    ...
    public function _EventEntityMetadata(event : _Super_Event)
    {
        ...
        if (model_internal::dependentsOnMap == null)
        {
            ...
            model_internal::dependentsOnMap["tl"] = new Array();
        ...
        model_internal::_instance = event;     
    }
    ...
    public function get isValid() : Boolean
    {
     ...
     [Bindable(event="propertyChange")] 
     public function get isTlAvailable():Boolean
     {
        return true;
     }                       
    ...
    [Bindable(event="propertyChange")]   
    public function get tlStyle():com.adobe.fiber.styles.Style
    {
		return model_internal::_nullStyle;		
    }      
